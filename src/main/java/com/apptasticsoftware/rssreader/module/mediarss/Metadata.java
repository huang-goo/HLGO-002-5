...
public interface Metadata {
     ...
     */
    Optional<MediaTitle> getMediaTitle();
     ...
     */
    void setMediaTitle(MediaTitle mediaTitle);
     ...
     */
    Optional<MediaDescription> getMediaDescription();
     ...
     */
    void addMediaKeyword(String mediaKeyword);
     ...
     */
    void addMediaCategory(MediaCategory mediaCategory);
     ...
     */
    void addMediaHash(MediaHash mediaHash);
     ...
     */
    Optional<MediaPlayer> getMediaPlayer();
     ...
     */
    void addMediaCredit(MediaCredit mediaCredit);
     ...
     */
    Optional<MediaCopyright> getMediaCopyright();
     ...
     */
    void setMediaCopyright(MediaCopyright mediaCopyright);
     ...
     */
    void addMediaText(MediaText mediaText);
     ...
     */
    List<MediaRestriction> getMediaRestrictions();
     ...
     */
    Optional<MediaCommunity> getMediaCommunity();
     ...
     */
    void setMediaCommunity(MediaCommunity mediaCommunity);
     ...
     */
    void addMediaComment(String mediaComment);
     ...
     */
    Optional<MediaEmbed> getMediaEmbed();
     ...
     */
    void setMediaEmbed(MediaEmbed mediaEmbed);
     ...
     */
    void addMediaResponse(String mediaResponse);
     ...
     */
    void addMediaBackLink(String mediaBackLink);
     ...
     */
    Optional<MediaStatus> getMediaStatus();
     ...
     */
    List<MediaPrice> getMediaPrices();
     ...
     */
    void addMediaPrice(MediaPrice mediaPrice);
     ...
     */
    List<MediaLicense> getMediaLicenses();
     ...
     */
    void addMediaLicense(MediaLicense mediaLicense);
     ...
     */
    List<MediaSubTitle> getMediaSubTitles();
     ...
     */
    void addMediaSubTitle(MediaSubTitle mediaSubTitle);
     ...
     */
    List<MediaPeerLink> getMediaPeerLinks();
     ...
     */
    void addMediaPeerLink(MediaPeerLink mediaPeerLink);
     ...
     */
    List<MediaLocation> getMediaLocations();
     ...
     */
    List<MediaScene> getMediaScenes();
     ...
     */
    void addMediaScene(MediaScene mediaScenes);
}
